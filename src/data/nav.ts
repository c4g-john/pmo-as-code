...
export const NAV: NavGroup[] = [
  {
    ...
    pages: [
      ...
      { title: 'Case study: Refuge', path: '/case-study/', srcPath: 'src/content/pages/case-study.md',
  ...
  },
  {
    ...
    color: 'var(--l1)',
    pages: [
      { title: 'Principles', path: '/principles/', srcPath: 'src/content/pages/principles.md',
        summary: 'The five defaults, and why the right-hand column is an exception rather than a ban. Includes the author statement.' },
      { title: 'Automation & audit', path: '/principles/automation/', srcPath: 'src/content/pages/principles-automation.md',
        summary: 'Gates move from the default to the documented exception; policy becomes code.' },
      { title: 'Traceability', path: '/principles/traceability/', srcPath: 'src/content/pages/principles-traceability.md',
  ...
  },
  {
    ...
    pages: [
      ...
      { title: 'Quickstart', path: '/quickstart/', srcPath: 'src/content/pages/quickstart.md',
        summary: 'Empty repo to merged validated document in eight steps with docassert.' },
      { title: 'Quickstart with Claude Code', path: '/quickstart-claude/', srcPath: 'src/content/pages/quickstart-claude.md',
        summary: 'The same setup driven by Claude Code from one prompt, including Word-document conversion.' },
      { title: 'Guides', path: '/guides/', srcPath: 'src/content/pages/guides.md',
