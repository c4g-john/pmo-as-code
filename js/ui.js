...
export function provenanceFooter(route) {
  const src = (PAGE_META[route] || {}).src || 'content/index.mdx';
  return `<footer class="provenance">
    <span style="display:inline-flex;align-items:center;gap:7px;">
      ...
      <span style="color:var(--ink-2);">${src}</span>
    </span>
    <span class="prov-sep">|</span>
    <span>commit <span style="color:var(--ink-2);">a1f3c9d</span></span>
    <span class="prov-sep">|</span>
    <span class="prov-ok"><span class="prov-ok-dot"></span><span style="color:var(--ok);">passing</span></span>
    <a class="prov-edit" href="#">Edit on Git →</a>
  </footer>`;
}
