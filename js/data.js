...
export const ROSETTA_ROWS = [
  ...
  { before: 'RAID log in Excel', after: 'Risk register in Git, checked on PR',
    ...
    output: `<div style="font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--ok);margin-bottom:6px;">✓ risk-items-complete</div><div style="font-size:13px;color:var(--muted);">PR #42 · reviewed by jordan.lee<br>threatens AUR-BR-001</div>` },
