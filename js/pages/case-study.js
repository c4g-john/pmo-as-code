...
<span class="cs">🟠 product requirement covered by an acceptance criterion: 4/10</span> <span class="cc"># six PRs untested</span>`)}
      ...
      <section class="thread-section" id="cs-bridge">
        <span class="thread-node"></span>
        <div class="eyebrow">The execution bridge</div>
        <h2 class="h2">Approved stories became a governed board.</h2>
        <p class="body">When the user stories were approved, the bridge scaffolded delivery in one pass. Ten product requirements became Feature issues, ten stories became sub-issues beneath them, and every item landed on a Projects board carrying its document id and project. The gate is real: draft stories never reach the board, and the whole structure regenerated idempotently on the second run.</p>
        <p class="body">The scope guard proved itself the same day. A test issue titled "Add dark mode" was flagged <code class="mono" style="font-size:13px;background:var(--panel-2);padding:1px 4px;border-radius:3px;">scope:unverified</code> within seconds of creation, with a comment pointing at the documents as the place scope changes actually happen. The project page now shows a Delivery panel reading from the board beside the document-derived status, and a Feature closes itself when its last story lands.</p>
        <div style="display:flex;flex-wrap:wrap;gap:10px;">
          <a class="btn-secondary" href="https://c4g-john.github.io/refuge-for-humans-pmo/PRJ-001-RFH.html" target="_blank" rel="noopener">The live dashboard →</a>
          <a class="btn-secondary" href="https://github.com/c4g-john/refuge-for-humans-app/issues" target="_blank" rel="noopener">The issues →</a>
        </div>
      </section>
