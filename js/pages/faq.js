...
export function renderFAQ() {
  const faqs = [
    ...
    { q: 'Who owns the standard?', a: 'The Manifesto (Layer 1) is meant to be owned by no one, like the Agile Manifesto. The reference approach (Layer 2) — the specification, templates, criteria, and docassert — is maintained by John Tanner at C4G Enterprises as a public, Apache-licensed library you can fork. Profiles (Layer 3) are open to anyone.' },
  ];
